...
// //     e.preventDefault();
// //     // تصفية المستخدمين بناءً على البريد الإلكتروني فقط
// //     const filtered = allUsers.filter(
// //       (u) => u.email?.toLowerCase().includes(searchTerm.toLowerCase()) // البحث باستخدام البريد الإلكتروني فقط
// //     );
...
export default function Adduser({ onClose, setChats }) {
  ...
  const handleAddUser = async (user) => {
    ...
    try {
      ...
      // إغلاق النافذة بعد إضافة المستخدم
      onClose();
