...
//     try {
//       // استخدام Firebase Auth لإنشاء مستخدم جديد
//       await createUserWithEmailAndPassword(auth, email, password);

//       // إظهار رسالة نجاح
//       toast.success("Registration successful!");

//       // هنا ممكن تضيف إعادة التوجيه لصفحة أخرى مثلاً:
//       // window.location.href = "/login"; // أو استخدم React Router لو كنت تستخدمه
//     } catch (error) {
